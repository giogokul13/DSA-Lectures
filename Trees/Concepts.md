...
Self Balancing Binary Tree.
 ...
 The height of each node in the tree is  -1, 1 or Zero
For eevery node in the tree the diff in height of left and right of node <= 1 - is called as Balanced tree


Self Balancing Binary Tree
 - Balancing a un balanced binary Tree 
  Example AVL Adelson-Velsky and Landis

<img width="907" alt="image" src="https://github.com/giogokul13/DSA-Lectures/assets/63816836/41ee212d-82ca-4f51-b403-7d776caf3917">


Algorithm;
1. Insert Normally - Node n
2. Start from node n and find the node that makes the tree unbalanced. - Left Rotate
3. use one the 4 rules and rotate

Rules
1. Right Rotate
2. Left Rotate
3. Left rotate Child Right Rotate Parent
4. Right Rotate Child Left Rotate Parent.
